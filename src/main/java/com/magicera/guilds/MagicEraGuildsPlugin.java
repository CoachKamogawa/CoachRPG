diff --git a/src/main/java/com/magicera/guilds/MagicEraGuildsPlugin.java b/src/main/java/com/magicera/guilds/MagicEraGuildsPlugin.java
index 791cb849cf0f2aea22db2b88a5eb85b6cc69969f..8a32bb40968662ac22a0c8582108a1a53c3cc020 100644
--- a/src/main/java/com/magicera/guilds/MagicEraGuildsPlugin.java
+++ b/src/main/java/com/magicera/guilds/MagicEraGuildsPlugin.java
@@ -1,127 +1,191 @@
...
+        initiator.sendMessage("§aGuild tax cycle (" + reason + ") complete. Members charged: §f" + chargedMembers
+                + "§a, failed charges: §f" + failedMembers + "§a, total: §f$" + String.format("%.2f", totalCollected));
+    }
+
     @Override
